...
In this post, I begin discussing a rigidty result proven in [Grognet](https://www.cambridge.org/core/journals/ergodic-theory-and-dynamical-systems/article/flots-magnetiques-en-courbure-negative/367C1356787B5F92F3C976BE84990D9B) for magnetic flows.
...
$$ \frac{1}{2} f_s''(t) \geq \left( \frac{5}{4} \|b\|^2 + \|D_\sbullet b T\|^2 \right) \|Y\|^2 - R(T,Y,T,Y).$$
...
$$ \frac{5}{4} \|b\|^2 + \|D_\sbullet b\| \leq k_1^2,$$
